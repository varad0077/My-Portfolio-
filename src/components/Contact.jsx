...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Celebration confetti with sage colors
    confetti({
      particleCount: 50,
      spread: 60,
      origin: { y: 0.6 },
              ...
              <div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', minWidth: 0 }}>
                    ...
                    <span style={{ fontWeight: 500, color: 'var(--text-main)', fontSize: '0.92rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {profileData.email}
                    </span>
                  </div>
